        ...
        <div>
          ...
          <main>
            <div>
              <div>
                <Switch>
                  <Route exact path={`${path}/details`} render={() => <LocationDetails location={locationObject} />}/>
                  <Route exact path={`${path}/npcs`} render={props => <NPCs { ...props } locationObject={locationObject} npcs={npcs} />}/>
