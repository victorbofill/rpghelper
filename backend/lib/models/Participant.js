...
const schema = new Schema({
  ...
  blinded: { type: String, default: 'none', enum: ['none', 'minor', 'catastrophic']},
  burning: { type: Number, default: 0 },
  crippled: { type: String, default: 'none', enum: ['none', 'minor', 'catastrophic']},
  deafened: { type: String, default: 'none', enum: ['none', 'minor', 'catastrophic']},
